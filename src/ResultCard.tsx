function ResultCard() {
  return (
    <div className="py-5 px-10 z-10 sm:max-w-xs sm:rounded-t-3xl bg-gradientRoyalBlue bg-gradient-to-t from-gradientRoyalBlue from-20% to-gradientSlateBlue text-center flex flex-col items-center justify-between rounded-b-3xl sm:shadow-2xl sm:-mr-8">
